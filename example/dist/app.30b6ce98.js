...
var actionType = 'get default state';
...
var combineReducers = function combineReducers(reducers) {
    ...
    if (!Object.values(reducers).every(function (item) {
    ...
    // 创建默认值
    var defaultState = mapValues(reducers, function (reducer, key) {
        return reducer(undefined, { type: actionType });
    });
    ...
    var finalReducer = function finalReducer() {
        ...
        // })
        var newState = mapValues(reducers, function (reducer, key) {
...
var _myRedux = require('../dist/my-redux');
...
var id = function id(state) {
    return Object.keys(state).reduce(function (result, value) {
...
var todo_add = function todo_add(todo) {
    return {
...
var todo_delete = function todo_delete(id) {
    return {
        ...
        case actionsNames.TODO_ADD:
            {
                ...
                return Object.assign({}, state, _defineProperty({}, newTodo.id, newTodo));
            }
        default:
            return state;
    }
...
var ids = function ids() {
    ...
    switch (action.type) {
        case actionsNames.TODO_ADD:
            {
                return [].concat(_toConsumableArray(state), [id(state)]);
            }
        default:
            return state;
    }
...
var todoReducer = (0, _myRedux.combineReducers)({
    byId: byId,
    ids: ids
});

var store = (0, _myRedux.createStore)(todoReducer, {});

window.store = store;

exports.actions = actions;
exports.store = store;
},{"../dist/my-redux":12}],18:[function(require,module,exports) {
/*
object-assign
(c) Sindre Sorhus
@license MIT
...
},{"fbjs/lib/invariant":16,"fbjs/lib/warning":17,"./lib/ReactPropTypesSecret":14}],9:[function(require,module,exports) {
...
},{"object-assign":18,"fbjs/lib/invariant":16,"fbjs/lib/emptyObject":20,"fbjs/lib/warning":17,"fbjs/lib/emptyFunction":15,"prop-types/checkPropTypes":13}],6:[function(require,module,exports) {
'use strict';
...
},{"./cjs/react.development.js":9}],11:[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"fbjs/lib/emptyFunction":15,"fbjs/lib/invariant":16,"fbjs/lib/warning":17,"object-assign":18,"./lib/ReactPropTypesSecret":14,"./checkPropTypes":13}],8:[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"./factoryWithTypeCheckers":11}],21:[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"fbjs/lib/invariant":16,"react":6,"fbjs/lib/warning":17,"fbjs/lib/ExecutionEnvironment":21,"object-assign":18,"fbjs/lib/emptyFunction":15,"prop-types/checkPropTypes":13,"fbjs/lib/getActiveElement":22,"fbjs/lib/shallowEqual":23,"fbjs/lib/containsNode":24,"fbjs/lib/emptyObject":20,"fbjs/lib/hyphenateStyleName":25,"fbjs/lib/camelizeStyleName":26}],7:[function(require,module,exports) {
'use strict';
...
},{"./cjs/react-dom.development.js":10}],30:[function(require,module,exports) {
var bundleURL = null;
...
var Todo = function (_Component) {
    ...
    _createClass(Todo, [{
        ...
        value: function render() {
            var _state$todoData = this.state.todoData,
                todoData = _state$todoData === undefined ? {} : _state$todoData;
            var _todoData$id = todoData.id,
                id = _todoData$id === undefined ? 0 : _todoData$id,
                _todoData$todo = todoData.todo,
                todo = _todoData$todo === undefined ? '' : _todoData$todo;
...
var TodoInput = function (_Component3) {
    _inherits(TodoInput, _Component3);
...
},{"./store":4,"react":6,"prop-types":8,"react-dom":7,"./style.css":3}],36:[function(require,module,exports) {
